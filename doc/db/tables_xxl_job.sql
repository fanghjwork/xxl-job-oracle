...
------------------------------------------------ 触发器
create or replace trigger xxl_job_group_tig
...
end xxl_job_group_tig;
/

create or replace trigger xxl_job_info_tig
...
end xxl_job_info_tig;
/

create or replace trigger xxl_job_logglue_tig
...
end xxl_job_logglue_tig;
/

create or replace trigger xxl_job_log_report_tig
...
end xxl_job_log_report_tig;
/

create or replace trigger xxl_job_log_tig
...
create or replace trigger xxl_job_registry_tig
...
end xxl_job_registry_tig;
/

create or replace trigger xxl_job_user_tig
...
INSERT INTO xxl_job_info(id, job_group, job_cron, job_desc, add_time, update_time, author, alarm_email, executor_route_strategy, executor_handler, executor_param, executor_block_strategy, executor_timeout, executor_fail_retry_count, glue_type, glue_source, glue_remark, glue_updatetime, child_jobid) VALUES (1, 1, '0 0 0 * * ? *', '测试任务1', sysdate, sysdate, 'XXL', '', 'FIRST', 'demoJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化',sysdate, '');
